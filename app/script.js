$(document).ready(function() {
        ...
        $(postit).draggable({
            ...
            stop: (event, ui) => {
                ...
                copie.appendTo($(postit).parent()).draggable({
                    ...
                    containment: 'section',
                    stop: (event, ui) => {
                      if (ui.position.left <= wCellule && ui.position.top + postit.width > hSection - wCellule) {
                        copie.remove()
                      }
                    }
                })
    ...
    ["#FF9117","#B33514","#FF5700","#0079B3","#00FFEA"].forEach((c, n) => creerCache(c, n))
